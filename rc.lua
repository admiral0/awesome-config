...
-- Textclock
mytextclock = awful.widget.textclock(markup.font("Termsyn 3", " ") ..
                                     markup(white, " %H:%M "))
...
small_spr = wibox.widget.textbox('<span font="Termsyn 4"> </span>')
med_spr = wibox.widget.textbox('<span font="Termsyn 7"> </span>')
